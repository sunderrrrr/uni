...
const casesData = [
  ...
  },
  {
    ...
    initials: "Д Е",
    story:
      "Год готовился к поступлению, но в апреле понял: специальность «Информационная безопасность» — это не его история, он хотел работать с людьми, а не с кодом. Пересобрали документы за две недели, выбрали социологию. Теперь он — профсоюзный лидер на курсе.",
    university: "МГУ",
    faculty: "Социология",
    category: "choice",
    tag: "Сменил за месяц",
  },
  {
    ...
    initials: "А Н",
    story:
      "Долго сомневался между программированием и дизайном. Мы нашли программу «Интерактивный дизайн» — там и то, и другое. Теперь он делает интерфейсы для стартапов и кайфует от учебы.",
    university: "НИУ ВШЭ",
    faculty: "Интерактивный дизайн",
    category: "choice",
    tag: "Нашёл гибрид",
  },
];
